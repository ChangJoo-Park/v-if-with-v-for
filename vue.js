...
function genElement (el) {  
  if (el.staticRoot && !el.staticProcessed) {
    console.log('genElement - genStatic');
    return genStatic(el)
  } else if (el.once && !el.onceProcessed) {
    console.log('genElement - Once');
    return genOnce(el)
  } else if (el.for && !el.forProcessed) {
    console.log('genElement - For');
    return genFor(el)
  } else if (el.if && !el.ifProcessed) {
    console.log('genElement - If');
    return genIf(el)
  } else if (el.tag === 'template' && !el.slotTarget) {
    console.log('genElement - Children');
    return genChildren(el) || 'void 0'
  } else if (el.tag === 'slot') {
    console.log('genElement - Slot');
    return genSlot(el)
  } else {
    console.log('genElement - else');
...
function genFor (el) {
  ...
  console.log('-----');
  console.log("_l((" + exp + "),", "function(" + alias + iterator1 + iterator2 + "){", "return " + (genElement(el)), '})')
  console.log('-----');
  return "_l((" + exp + ")," +
